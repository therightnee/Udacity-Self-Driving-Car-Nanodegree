...
Used all three camera angles available, took data in on the first track in going clockwise and counterclockwise in either lane, and also driving down the center. I also took data of the vehicle driving in both directions on the second track to increase the size of the data set, and change the environment.
